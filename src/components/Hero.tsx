    ...
    <section className="bg-brand-black text-white">
      <div className="max-w-5xl mx-auto px-6 py-16 flex flex-col md:flex-row items-center gap-10">
        <div className="flex-1 text-center md:text-left">
          <p className="text-brand-green font-body text-sm uppercase tracking-widest mb-4">
            Para mulheres 45+
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 justify-center md:justify-start">
            <a
              href="#comprar"
              className="bg-brand-green hover:bg-brand-green/80 text-brand-black font-body font-bold text-lg px-8 py-4 rounded-full transition-colors w-full sm:w-auto text-center"
            >
