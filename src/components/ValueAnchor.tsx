  ...
  return (
    <section className="bg-brand-white py-16 px-6">
      <div className="max-w-3xl mx-auto text-center">
        <h2 className="font-heading text-3xl text-brand-black font-bold mb-6">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm mb-8">
          <div className="flex flex-col md:flex-row items-center gap-6 justify-center">
            ...
            <div className="text-4xl text-brand-green font-heading">vs</div>
            <div className="text-center p-6 bg-brand-green rounded-xl flex-1">
              <p className="font-body text-sm text-brand-black/70 mb-2">
                Guia Prático da Casa Organizada
              </p>
              <p className="font-heading text-4xl font-bold text-brand-black">
                R$ 47,00
              </p>
              <p className="font-body text-xs text-brand-black/60 mt-1">
