    ...
    <section className="bg-sage-dark text-white py-16 px-6">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="font-body text-white/80 text-lg mb-8 leading-relaxed">
          ...
          <span className="text-gold font-bold">R$ 47,00</span>
        </p>
        <a
          href="#"
          className="inline-block bg-gold hover:bg-gold-light text-olive-deep font-body font-bold text-xl px-8 py-5 rounded-full transition-colors mb-6"
        >
